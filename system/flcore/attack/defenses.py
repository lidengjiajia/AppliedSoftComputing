...
class FedACTDefense(BaseDefense):
    ...
    def __init__(
        ...
        vote_threshold: float = 0.4,       # 提高投票阈值（从0.5降到0.4减少FP）
        dataset_type: str = None,
    ...
    def aggregate(
        ...
        # 可配置的阈值系数（优化后提高精确度）
        # 调优策略：缩小不确定区域，提高阈值减少假阳性
        lower_coef = 0.85   # 委员会投票下界（从0.7提高到0.85）
        upper_coef = 1.8    # 直接拒绝上界（从1.5提高到1.8）
